...
Needed only when pytest collects python/synthesizer/tests together with python/policies/tests
...
def load_dispatch():
    spec = importlib.util.spec_from_file_location("synth_dispatch_module", _PATH)
